...
class CriminalRecords(abc):
    ...
    def __init__(self, criminal_records_id: str, criminal: Criminal, crime_type: CRIMINAL_TYPE, arrested: bool):
        ...
        @staticmethod
        def validate_crime_types(crime_type: CRIMINAL_TYPE) -> bool:
            if type(crime_type) is not CRIMINAL_TYPE:
                return False
